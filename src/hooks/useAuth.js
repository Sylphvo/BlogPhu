...
// redux
import { login, register, logout, sendMail } from '../redux/slices/authJwt';
// import {
//   confirmRollback,
//   cancelTransaction
...
export default function useAuth(method = 'jwt') {
  ...
  if (method === 'jwt') {
    return {
      ...
      // confirmRollback: (admin, transId, username) =>
      //   dispatch(confirmRollback(admin, transId, username)),

      // cancelTransaction: (admin, transId, username) =>
      //   dispatch(cancelTransaction(admin, transId, username)),
