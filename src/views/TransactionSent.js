...
// // redux
// import { getNewSends } from '../redux/slices/transaction';
// // // routes
...
//       array,
//       (transSend) =>
//         transSend.username.toLowerCase().indexOf(query.toLowerCase()) !== -1
//     );
//   }
...
//   const { transSend, totalSend } = useSelector((state) => state.transaction);
...
//   useEffect(() => {
//     dispatch(getNewSends(key, pagesize, pageindex));
...
//     if (newPage % 3 === 0 && transSend.length <= (newPage + 3) * pagesize) {
...
//   const emptyRows =
//     pageindex > 0
//       ? Math.max(0, (1 + pageindex) * pagesize - transSend.length)
//       : 0;
...
//                                     arrow
//                                   >
//                                     <span>{cliTruncate(fromAddress, 15)}</span>
//                                   </Tooltip>
//                                 </CopyToClipboard>
//                               )}
//                             </TableCell>
...
//                                     arrow
//                                   >
//                                     <span>{cliTruncate(toAddress, 15)}</span>
//                                   </Tooltip>
//                                 </CopyToClipboard>
//                               )}
//                             </TableCell>
