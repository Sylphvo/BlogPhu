...
//   const { transWaitEth, issuccessful, totalWaitEth } = useSelector(
...
//   useEffect(() => {
//     dispatch(getTransactionsWait(key, 'eth', pagesize, pageindex));
...
//     if (newPage % 3 === 0 && transWaitEth.length <= (newPage + 3) * pagesize) {
...
//   const emptyRows =
//     pageindex > 0
//       ? Math.max(0, (1 + pageindex) * pagesize - transWaitEth.length)
//       : 0;
