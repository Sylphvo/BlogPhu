...
//       array,
//       (transDeposit) =>
//         transDeposit.username.toLowerCase().indexOf(query.toLowerCase()) !== -1
//     );
//   }
...
//   const { transDeposit, totalDeposit } = useSelector(
...
//   useEffect(() => {
//     dispatch(getTransactions(pagesize, pageindex, key, 'deposit'));
...
//     if (newPage % 3 === 0 && transDeposit.length <= (newPage + 3) * pagesize) {
...
//   const emptyRows =
//     pageindex > 0
//       ? Math.max(0, (1 + pageindex) * pagesize - transDeposit.length)
//       : 0;
